...
//Clase Mago que hereda la clase jugador
public class Mago extends Jugador{

    /*
    Constructor de la clase Mago, donde se establecen los estados iniciales del jugador tipo Mago.
    */
    public Mago(String nombre){
        ...
        //
        this.setVida_max(10);
        this.setFuerza_max(3);
        this.setInteligencia_max(10);
        this.setEnergia_max(6);
        this.setMana_max(15);
    }
    ...
    */
    public void Mejorar(){
        this.setVida_max(this.getVida_max()+2*this.getNivel());
        this.setFuerza_max(this.getFuerza_max()+1);
        this.setInteligencia_max(this.getInteligencia_max()+3*this.getNivel());
        this.setEnergia_max(this.getEnergia_max()+1);
        this.setMana_max(this.getMana_max()+this.getMana_max()*3);
        //
    ...
    */
    ...
    public int ataque() {
        ...
        if(this.getEnergia()>0){
            ...
            suma = (this.getFuerza()*((int)(this.getInteligencia()/4)))+(this.getEnergia()+3);
    ...
    En caso contrario, se verá si el maná es menor a 5 (pero todavia mayor a 0) y si se cumple el hechizo se ejecuta de igual manera
    y el maná se establece en 0.
    En caso de que el maná sea mayor o igual a 5 se resta del maná el costo del hechizo (5).
    ...
    */
    ...
    public int hechizo() {
        ...
        if(this.getMana()>0){
            ...
            suma = (this.getInteligencia()*((int)(this.getFuerza()/4)))+(this.getMana()+5);
            mana_final = (this.getMana()<0) ? 0:this.getMana();
        }
        else{
            suma = mana_final = 0;
        }
        setEnergia(mana_final);
        return suma;
    }
